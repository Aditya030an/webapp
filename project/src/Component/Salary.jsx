...
//     updated[index][field] =
//       field === "salary" ? Number(value) : field === "paid" ? value === "true" : value;
//     setEmployees(updated);
//   };

//   const addEmployee = () => {
//     setEmployees([...employees, { name: "", role: "", month: "", salary: 0, paid: false }]);
//   };
...
//           <button className="bg-gray-300 text-gray-800 px-4 py-2 rounded-lg">Print</button>
//         </div>
//       </div>
//     </div>
//   );
...
// const Salary = () => {
//   const [entries, setEntries] = useState([{ employee: "", amount: 0 }]);
...
//   const addEntry = () => {
//     setEntries([...entries, { employee: "", amount: 0 }]);
//   };
...
//       <div className="max-w-3xl mx-auto bg-white p-8 mt-6 rounded-xl shadow-md">
//         <h2 className="text-2xl font-bold text-gray-800 mb-6">Salary Management</h2>
...
//         <div className="flex justify-end space-x-4">
//           <button className="bg-blue-500 text-white px-4 py-2 rounded-lg">Save</button>
//           <button className="bg-gray-300 text-gray-800 px-4 py-2 rounded-lg">Export</button>
//         </div>
//       </div>
//     </div>
//   );
